...
<nav class="#header" >
  ...
  <!-- Header -->
			...
			<header id="header" class="alt" >
				...
				<div class="logo"><a href="index.php"> <span>BD Arts</span></a></div>
 ...
 <a href="javascript:;" style="padding: 0px 0; color:#000;margin-right: 3em;">
                  ...
                  <form class="navbar-form navbar-left" action="welcome.php" method="post">
                    ...
                    <div class="input-group" >
                      ...
                      <input list="browsers" name="proname" type="text" class="form-control" style="color: #2f2f2f; max-height: 35px;
" placeholder="Search Product" required>
                      ...
                      <button class="btn btn-default" type="submit" style="max-height: 35px; margin-bottom: 10px;
" name="search">
