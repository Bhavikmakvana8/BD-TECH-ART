      ...
      <div class="row">
         <?php
            	...
            	while($result=mysqli_fetch_array($run))
            {
            	...
            	<div style='background:#2f2f2f;color:#fff;font-size:16px;font-weight:bold;' class='text-center text-capitalize'><span>$result[1] |   <span style='text-decoration:line-through;'>Less(Rs.):$result[4]</span> | Rs.$result[3]</span></div><div class='product-des' style='background:#000;color:#fff;font-size: 16px;height:50px;overflow-y:hidden;' class='text-center'><span>$result[6]</span></div><div class='text-center'style='background:#FFCB74;font-size: 20px;'><a href='bookingbycustomer.php?id=$result[0]' style='color:#fff'>Booking Now</a></div></div></div>";
            	...
            	while($result=mysqli_fetch_array($run))
            {
              ...
              <div style='border: 2px solid #000;margin: 20px;text-align: -webkit-center;'>
            	...
            	<div style='background:#2f2f2f;color:#fff;font-size:15px;font-weight:bold;' class='text-center text-capitalize'>
